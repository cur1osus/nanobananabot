...
from bot.keyboards.music import ik_music_back_home, ik_music_topic_text_menu
...
async def style_selected(
    ...
    if style_key == "custom":
        await edit_or_answer(
            ...
            reply_markup=await ik_music_back_home(back_to=MusicBackTarget.TITLE),
        )
        return
...
async def topic_style_selected(
    ...
    if style_key == "custom":
        await edit_or_answer(
            ...
            reply_markup=await ik_music_back_home(back_to=MusicBackTarget.TOPIC_STYLE),
        )
        return
