...
ADULT_PROMPT_REQUEST_TEXT = (
    "Теперь опишите, что нужно изменить. Чётко укажите, какую одежду снять "
    "или на что заменить, и опишите результат — чем понятнее, тем лучше сработает.\n\n"
    "Например:\n"
    "• «убери платье и лифчик, оставь только трусики»\n"
    "• «сними рубашку и джинсы, надень чёрное бельё»\n"
    "• «замени купальник на кружевной комплект»\n\n"
    "💡 Можно ввести текстом или продиктовать голосом"
)
...
AI_PROMPT_MODE_TEXT = (
    "✨ Промпт с помощью ИИ\n\n"
    "Выберите, как создать промпт:\n"
    "• ✍️ Обогатить мой промпт — пришлите свой черновик, ИИ его улучшит\n"
    "• 🎲 Создать по теме — задайте тему/идею, ИИ придумает промпт с нуля"
)

AI_PROMPT_ENRICH_ASK = (
    "✍️ Пришлите ваш черновик промпта — ИИ обогатит его в сильный промпт."
)
...
ADULT_CONSENT_TEXT = (
    "🔞 Раздел 18+\n\n"
    "Здесь можно генерировать контент для взрослых.\n"
    "Доступ разрешён только совершеннолетним пользователям.\n\n"
    "Нажимая «Мне есть 18 лет», вы подтверждаете, что вам исполнилось 18 лет "
    "и вы согласны просматривать материалы для взрослых."
)
...
def topup_methods_text(user: UserRD) -> str:
    return f"Ваш баланс: {user.credits} кредитов.\n\nВыберите способ оплаты:"
