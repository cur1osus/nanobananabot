...
IMAGE_MODELS: Final[tuple[ImageModelOption, ...]] = (
    ImageModelOption(
        ...
        cost=1,
        details="лучше базовое качество",
    ...
    ImageModelOption(
        ...
        cost=3,
        details="лучше качество и детали",
        button_label="🆕 Nano2 (3 кр)",
    ),
    ImageModelOption(
        key="pro",
        title="Pro",
        api_model="gemini-3-pro-image-preview",
        create_api_model="imagen-4.0-generate-001",
        cost=4,
        details="максимум качества для генерации",
